...
def open_google_and_search(text):
    ...
    speak("Đây là thông tin bạn tìm kiếm")
...
def assistant():
    ...
    if name:
        ...
        while True:
            ...
            if not text:
                break
            elif "tạm biệt"in text or "Googbye" in text:
                stop()
                break
            elif "có thể giúp gì" in text:
                help_me()
            elif "chào trợ lý ảo" in text:
                hello(name)
            elif "hiện tại" in text or "hôm nay là bao nhiêu" in text:
                get_time(text)
            elif "tìm kiếm" in text or "tìm" in text:
                open_google_and_search(text)
            elif "" in text:
                open_website(text)
            elif "mở" in text:
                open_application(text)
            elif "dự báo thời tiết" in text:
                thoitiet()
